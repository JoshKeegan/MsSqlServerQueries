/*
	Identifies all single column statistics that are overlapped by other stats (share the same leading column)
	By Kendan Van Dyke
	Src: http://www.pythian.com/blog/sql-server-statistics-maintenance-and-best-practices/
*/
